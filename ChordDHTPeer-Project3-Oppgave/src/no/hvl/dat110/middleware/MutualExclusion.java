...
public class MutualExclusion {
	...
	public boolean doMutexRequest(Message message, byte[] updates) throws RemoteException {
		...
		if(areAllMessagesReturned(duplicatesRemoved.size())) {
		...
		// return permission
		boolean permission = areAllMessagesReturned(duplicatesRemoved.size());
		return permission;
	}
	...
	private void multicastMessage(Message message, List<Message> activenodes) throws RemoteException {
		...
		for(Message active: activenodes) {
			...
			Util.getProcessStub(active.getNodeIP(), active.getPort()).onMutexRequestReceived(message);
